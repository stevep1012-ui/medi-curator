...
export const TRANSLATIONS: Record<Lang, Dict> = {
  ko: {
    ...
    symptom: {
      // "일반의약품 선택지를 정리합니다" 라고 약속하고 있었으나 서버는 OTC 를 항상
      // 비워 보낸다(법적 포지션). 하지 않는 일을 약속하는 문구라 영/일/중 판본과
      // 같은 취지로 맞춘다.
      disclaimer: "증상에 따라 흔히 확인하는 일반 건강정보를 정리합니다. 전문적인 진료를 대체하지 않으며, 증상이 지속되거나 악화되면 의사·약사와 상담하세요.",
      symptomsLabel: "증상",
